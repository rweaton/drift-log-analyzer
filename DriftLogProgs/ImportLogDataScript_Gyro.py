...
def ImportData():
  ...
  opts = {}
  opts['filetypes'] = [('las files','.las'), ('LAS files', '.LAS'), ('csv files', '.csv'), ('All files', '.*')]
  ...
  DictIndex = raw_input('LAS file source? (0 = Eaton): ')
  ...
  ColumnHeadersDict = {'Depth':['DEPT'],  # Depth values header
                       'DevComp_North':['DEVN'],    # Deviation component in North direction
                       'DevComp_East':['DEVE'],    # Deviation component in the East direction
                       'DevComp_Down':['DEVD'],     # Deviation component in the downward direction  
                       'DevAzimuth':['AZIM'],      # Azimuthal angle of the deviation vector
                       'DevInclination':['DEV'],  # Inclination angle of the deviation vector
                       'hline':[44]               # Line containing header info (counting from 0)
                     }
  ...
  ColumnNames = np.array(['Depth', 'DevComp_North', 'DevComp_East', 'DevComp_Down', 'DevAzimuth', 'DevInclination'])
